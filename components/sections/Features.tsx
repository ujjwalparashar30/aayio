...
const features = [
  {
    ...
    header: (
      <div className="rounded-lg p-8 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 transition-colors duration-300">
        <div className="flex justify-center">
          <Zap className="w-12 h-12 text-black dark:text-white transition-colors duration-300" />
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    header: (
      <div className="rounded-lg p-8 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 transition-colors duration-300">
        <div className="flex justify-center">
          <Shield className="w-12 h-12 text-black dark:text-white transition-colors duration-300" />
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    header: (
      <div className="rounded-lg p-8 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 transition-colors duration-300">
        <div className="flex justify-center">
          <TrendingUp className="w-12 h-12 text-black dark:text-white transition-colors duration-300" />
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    header: (
      <div className="rounded-lg p-8 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 transition-colors duration-300">
        <div className="flex justify-center">
          <Globe className="w-12 h-12 text-black dark:text-white transition-colors duration-300" />
        </div>
      </div>
    ),
    icon: <Globe className="w-4 h-4 text-gray-600 dark:text-gray-400" />
  },
  {
    ...
    header: (
      <div className="rounded-lg p-8 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 transition-colors duration-300">
        <div className="flex justify-center">
          <Users className="w-12 h-12 text-black dark:text-white transition-colors duration-300" />
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    header: (
      <div className="rounded-lg p-8 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 transition-colors duration-300">
        <div className="flex justify-center">
          <BarChart3 className="w-12 h-12 text-black dark:text-white transition-colors duration-300" />
        </div>
      </div>
    ),
...
export default function Features() {
  return (
    <section id="features" className="py-20 relative bg-white dark:bg-black transition-colors duration-300">
